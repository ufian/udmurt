...
class Messenger(object):
    ...
    def write_ya(self, channel_id, user_id):
        txt = u"Официальная методичка яндекса тут https://yandex.ru/company/press_releases"
        self.send_message(channel_id, txt)
    ...
    def write_join(self, channel_id, user_id):
        ...
        #else:
        txt = u"<@rosnovsky> запиши подкаст! А то <@{0}> вряд ли узнает, что такое интеграл.".format(user_id)
        self.send_message(channel_id, txt)

    def write_prompt(self, channel_id):
        bot_uid = self.clients.bot_user_id()
        txt = "I'm sorry, I didn't quite understand... Can I help you? (e.g. `<@" + bot_uid + "> help`)"
        txt = random.choice([u"Зачем это?",
